	...
	class ThemeZee_Plugins_Page {
		...
		*/
		static function display_overview_page() {
			$plugin_link = '<a target="_blank" href="https://themezee.com/plugins/?utm_source=plugin-overview&utm_medium=teaser&utm_campaign=plugins" title="' . esc_html__( 'ThemeZee Plugins', 'themezee-social-sharing' ) . '">' . esc_html__( 'plugins', 'themezee-social-sharing' ) . '</a>';
			?>
